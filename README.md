...
- Dual-discriminative Graph Neural Network for Imbalanced Graph-level Anomaly Detection in *NeurIPS*, 2022. [\[paper\]](https://proceedings.neurips.cc/paper_files/paper/2022/hash/98a625423070cfc6ae3d82d4b59408a0-Abstract-Conference.html)[\[code\]]()
...
- Bi-Level Selection via Meta Gradient for Graph-based Fraud Detection in *DASFAA *, 2022. [\[paper\]](https://yliu.site/pub/BLS_DASFAA2022.pdf)[\[code\]]()

- H2-FDetector: A GNN-based Fraud Detector with Homophilic and Heterophilic Connections in *WWW*, 2022. [\[paper\]](https://dl.acm.org/doi/pdf/10.1145/3485447.3512195)[\[code\]]()
...
- Generation is better than Modification: Combating High Class Homophily Variance in Graph Anomaly Detection in *Arxiv*, 2024. [\[paper\]](https://arxiv.org/abs/2403.10339)[\[code\]]()

- Boosting Graph Anomaly Detection with Adaptive Message Passing in *ICLR*, 2024. [\[paper\]](https://openreview.net/forum?id=CanomFZssu)[\[code\]]()
...
- SmoothGNN: Smoothing-based GNN for Unsupervised Node Anomaly Detection in *Arxiv*, 2024. [\[paper\]](https://arxiv.org/abs/2405.17525)[\[code\]]()
...
- GADY Unsupervised Anomaly Detection on Dynamic Graphs in *Arxiv*, 2023. [\[paper\]](https://arxiv.org/abs/2310.16376)[\[code\]]()

- Generative Graph Augmentation for Minority Class in Fraud Detection in *CIKM*, 2023. [\[paper\]](https://dl.acm.org/doi/10.1145/3583780.3615255)[\[code\]]()
...
- Self-Discriminative Modeling for Anomalous Graph Detection in *Arxiv*, 2023. [\[paper\]](https://arxiv.org/abs/2310.06261)[\[code\]]()
...
- Graph Anomaly Detection with Few Labels: A Data-Centric Approach in *KDD*, 2024 [\[paper\]]()[\[code\]]() 
...
- AnomMAN: Detect Anomaly on Multi-view Attributed Networks in *Information Sciences*, 2022.[\[paper\]](https://arxiv.org/abs/2201.02822)[\[code\]]()

- A Deep Multi-View Framework for Anomaly in *TKDE*, 2022. [\[paper\]](https://ieeexplore.ieee.org/document/9162509)[\[code\]]()
...
- GATAE: Graph Attention-based Anomaly Detection on Attributed Networks [\[paper\]]()[\[code\]]()
...
+
- A graph encoder–decoder network for unsupervised anomaly detection in *Arxiv*, 2023 [\[paper\]](https://arxiv.org/abs/2308.07774)[\[code\]]()
...
- A Robust Embedding Method for Anomaly Detection on Attributed Networks [\[paper\]]()[\[code\]]()
...
- STRIPE Spatial-temporal Memories Enhanced Graph Autoencoder for Anomaly Detection in Dynamic Graphs [\[paper\]]()[\[code\]]()
...
- ANEMONE: Graph Anomaly Detection with Multi-Scale Contrastive Learning in *CIKM*, 2021 [\[paper\]](https://dl.acm.org/doi/10.1145/3459637.3482057)[\[code\]]()
...
- Few-shot Message-Enhanced Contrastive Learning for Graph Anomaly Detection  in *Arxiv*, 2023 [\[paper\]](https://arxiv.org/abs/2311.10370)[\[code\]]()
...
- BOURNE: Bootstrapped Self-supervised Learning Framework for Unified Graph Anomaly Detection in *Arxiv*, 2023 [\[paper\]](https://arxiv.org/abs/2307.15244)[\[code\]]()
...
- Learning Node Abnormality with Weak Supervision  in *CIKM*, 2023 [\[paper\]](https://dl.acm.org/doi/10.1145/3583780.3614950)[\[code\]]()

- Federated Graph Anomaly Detection via Contrastive Self-Supervised Learning in *TNNLS*, 2024 [\[paper\]](https://ieeexplore.ieee.org/document/10566052)[\[code\]]()
...
- Discriminative Graph-level Anomaly Detection via Dual-students-teacher Model in *Arxiv*, 2023 [\[paper\]](https://arxiv.org/abs/2308.01947)[\[code\]]()

- FGAD: Self-boosted Knowledge Distillation for An Effective Federated Graph Anomaly Detection Framework in *Arxiv*, 2024 [\[paper\]](https://arxiv.org/abs/2402.12761)[\[code\]]()
...
- ARC: A Generalist Graph Anomaly Detector with In-Context Learning in *Arxiv*, 2024  [\[paper\]](https://arxiv.org/abs/2405.16771)[\[code\]]()
...
- A Comprehensive Survey on Graph Anomaly Detection with Deep Learning in *TKDE*, 2021  [\[paper\]](https://arxiv.org/abs/2106.07178)[\[code\]]()
